...
public class UserController {
   ...
   * @return
   */
  @RequestMapping(value = "findManager",produces = "application/json;charset=utf-8")
  public @ResponseBody String findManager() {
    List<User> managers = userService.findManager();
    JSON json = JSONSerializer.toJSON(managers);
  ...
  public @ResponseBody String  find() {
    ...
    JSON json = JSONSerializer.toJSON(users);
    return json.toString();
  }
}
