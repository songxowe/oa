...
<body>
	<div>
		<form onsubmit="return checkInput3()" id="voteForm3" method="post">
			<input type="hidden" name="_method" value="post">
			<table id="tab5" border="1" cellspacing="0" style="float: left; height:321px;">
				<tr>
					<th>投票标题</th>
				...
				<tr>
					<th>终止时间</th>
					<td><input class="easyui-datetimebox" name="endTime" id="endTime3"  value='<fmt:formatDate value="${pubVote.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/>' style="width: 97%" data-options="required:true"></td>
				</tr>
				<tr>
					<th>发布范围(部门)</th>
				...
				<tr align="center" >
					<th colspan="2"><input type="button" onclick="checkInput3()" value="提交投票"></th>
				</tr>
			</table>
			<table id="tab6" border="1" cellspacing="0" style="float: left;width:253px">
				<tr align="center">
					<th colspan="3">点击按钮添加投票项输入</th>
				</tr>
			</table>
			<input type="button" id="additem3" value="添加投票项"> 
			<input type="hidden" name="votename" id="votename3">
		</form>
	</div>
	<script type="text/javascript">
		var count=$("#tab6 input[type='text']").length+1;
		...
		function checkInput3() {
			...
			$("#tab6 input[type='text']").each(function(){
				//alert($(this).val());
				var item=$(this).val();
			...
			if($("#voteForm3").form('validate')){
				$("#voteForm3").form('submit');
			}
			$("#votename3").val('');
			return true;
		}
		...
		function removeVote(id) {
			$("#additem3").show();
			$("#tab6 tr[name=" + id + "]").remove();
			//alert($("#tab6 input[type='text']").length);
			row=$("#tab6 input[type='text']").length+1;
		}
	</script>
</body>
</html>