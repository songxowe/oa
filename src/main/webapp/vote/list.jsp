...
<body>
	<input type="hidden" id="voteId" value="${param.voteId}">
	<div id="div1" style="float:left;width: 600px; height: 400px;">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/vote/js/echartstemp.js"></script>
